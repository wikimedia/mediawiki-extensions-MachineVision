...
class TitleFilter {
	...
	public function filterGoodTitles(
		...
		return array_filter( $filePageTitles, function ( $title ) use ( $localRepo, $minImageWidth,
			$categoryBlacklist, $templateBlacklist ) {
			return $this->isGoodTitle(
				$title,
				$localRepo,
				$minImageWidth,
				$categoryBlacklist,
